...
export function Card({ product }) {
    ...
    return (
        <>
            <div className='m-1'>
                <div class="flex flex-wrap  mt-2 bg-gradient-to-r from-zinc-800 via-zinc-600 to-zinc-700 z-40  rounded-xl drop-shadow-lg ">
                    <div class=" w-full lg:max-w-full lg:flex transition duration-300 hover:bg-zinc-800 rounded-2xl">
                        <div class=" lg:border-l-0  rounded-xl p-4 flex flex-col  leading-normal">
                            <button onClick={() => {
                                openModal();
                                handleView();
                            }}>
                                <div class="mb-8">
                                    <p class="text-sm text-gray-100 flex ">
                                    ...
                                    <div class="text-slate-200 font-bold text-xs md:text-base mb-2">{product.name.charAt(0).toUpperCase() + product.name.slice(1)}</div>
                                </div>
                                <div class="flex justify-start ">
                                    ...
                                    <div class="text-sm text-left">
                                        ...
                                        <p class="text-slate-300 text-xs  "> {product.timestamp}</p>
                                    </div>
                                </div>
                            </button>
                            <div className='flex justify-between m-4' >
                                <button type="button" class="text-blue-100  hover:bg-zinc-900  font-medium rounded-lg text-xs md:text-sm py-2 px-4 text-center inline-flex items-center me-2 ">

...
;
    ...
    return (
        <>
<footer>
    <div class="bg-gray-800 py-4 text-gray-400 mt-4">
      <div class="container px-4 mx-auto">
        <div class="-mx-4 flex flex-wrap justify-between">
                ...
                <g fill="none" fill-rule="evenodd">
                  <g transform="translate(0 -75)">
                    ...
                    <text fill="white" font-family="Nunito-Bold, Nunito" font-size="512" font-weight="bold">
                      <tspan x="654" y="518">TraviWeb</tspan>
                    </text>
                  </g>
                </g>
              </svg>
          ...
          <div class="px-4 my-4 w-full sm:w-auto xl:w-1/2 content-between">
            <div>
      ...
      <div class="container mx-auto px-4">
        <div class="-mx-4 flex flex-wrap justify-between">
          <div class="px-4 w-full text-center sm:w-auto sm:text-left">
            ...
            TraviWeb 2.0 . All Rights Reserved.
          </div>
          <div class="px-4 w-full text-center sm:w-auto sm:text-left">
            Made with ❤️ by TraviWeb 2.0 | Sthalin Rivera Centeno.
          </div>
        </div>
      </div>
    </div>

        ...
        <main className="flex-1 lg:p-4 bg-gray-100 dark:bg-gray-800">
          <div className="bg-white dark:bg-slate-900 shadow-lg p-4  rounded-lg">
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full bg-white dark:bg-gray-900 rounded-lg shadow-lg text-sm text-gray-900 dark:text-gray-200">
                <thead>
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center p-4">
          <div className="bg-white dark:bg-gray-900 p-6 rounded-lg shadow-lg w-full max-w-sm">
            <h2 className="text-lg font-bold mb-4">{editUserId ? "Editar Usuario" : "Agregar Usuario"}</h2>

        ...
        <div class="md:wrapper mt-4 ">
          <div className='bg-white shadow-[0_8px_12px_-6px_rgba(0,0,0,0.2)] border md:p-6 w-full  rounded-lg font-[sans-serif] overflow-hidden mx-auto my-4'>
            ...
            <div className='flex py-6 px-6 rounded-xl justify-between'>
              ...
              <div className='flex '>
                <Link to="/places"> <button className='button text-white mr-2' >List Posts</button></Link>
              </div>
            </div>
                  ...
                  <div class="bg-white rounded shadow-lg p-4 px-4 md:p-8 mb-6">
                    <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
                      ...
                      <div class="lg:col-span-2">
                        ...
                        <form onSubmit={store}>
                          <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 grid-cols-5">
                            ...
                            <div class="col-start-1 col-end-7  md:col-span-5 text-right">
                              <div class="md:inline-flex md:items-end">
                                <button type="submit" className={` text-white font-bold  w-full py-2 px-4 rounded ${per !== null && per < 100 ? ' bg-slate-500 disabled:bg-slate-500 cursor-not-allowed' : 'bg-blue-500'}`} >Submit</button>
                              </div>
                            </div>
                          </div>
                        </form>
